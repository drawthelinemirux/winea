...
import { RequestLeaveComponent } from 'app/entities/request-leave/request-leave.component';
...
describe('Component Tests', () => {
  describe('RequestLeave Management Component', () => {
    let comp: RequestLeaveComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.requestLeaves && comp.requestLeaves[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
