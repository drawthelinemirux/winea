...
describe('Employee e2e test', () => {
  ...
  it('should load Employees', async () => {
    ...
    expect(await employeeComponentsPage.getTitle()).to.eq('wineaApp.employee.home.title');
  });
  ...
  it('should load create Employee page', async () => {
    ...
    expect(await employeeUpdatePage.getPageTitle()).to.eq('wineaApp.employee.home.createOrEditLabel');
  ...
  it('should create and save Employees', async () => {
    ...
    expect(await employeeUpdatePage.getEmployeeidInput()).to.eq('5', 'Expected employeeid value to be equals to 5');
  ...
  it('should delete last Employee', async () => {
    ...
    expect(await employeeDeleteDialog.getDialogTitle()).to.eq('wineaApp.employee.delete.question');
